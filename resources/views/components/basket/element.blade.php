...
<tr class="bg-white border-b bg-gray-800 border-gray-700 hover:bg-gray-50 hover:bg-gray-600">
    ...
    <td class="px-6 py-4">
        <div class="flex items-center space-x-3">
            ...
            <label class="w-8 border border-gray-300 rounded-lg focus:border-blue-500 px-2.5 py-1 border-gray-600">
    ...
    <td class="px-6 py-4">
        <form action="{{ route('basket.removeProduct') }}" method="POST">
            ...
            @method('DELETE')
            <input type="hidden" name="product_id" value="{{ $product->id }}">
            <button class="font-medium text-red-600 text-red-500 hover:underline w-5">
