    ...
    <section class="pb-4">
        ...
        <table class="border border-collapse w-full">
            ...
            <tr>
                ...
                <th class="border px-4 py-2 border-gray-600 bg-gray-200 font-bold">Заголовок новости</th>
            ...
            <tr>
                ...
                <td class="border px-4 py-2">
                    @can('delete', $article)
                        <form class="flex items-center" action="{{ route('admin.articles.destroy', ['article' => $article]) }}" method="post">
                            @csrf
                            @method('DELETE')
                            <button class="inline-block bg-gray-400 hover:bg-opacity-70 focus:outline-none text-white font-bold py-2 px-4 rounded" title="Удалить" onclick="return confirm('вы уверены, что хотите удалить эту новость?')">
