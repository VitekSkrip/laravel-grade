<x-layouts.app>
    ...
    <div class="p-4">
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    <td class="w-32 p-4">
                        <a class="hover:opacity-75" href="detail.html">
                            <img src="assets/pictures/car_K5-half.png" alt="">
                        </a>
                    </td>
                    ...
                    <td class="px-6 py-4">
                        <button class="font-medium text-red-600 dark:text-red-500 hover:underline w-5">
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    <td class="w-32 p-4">
                        <a class="hover:opacity-75" href="detail.html">
                            <img src="assets/pictures/car_rio_new.png" alt="">
                        </a>
                    </td>
                    <td class="px-6 py-4 font-semibold text-gray-900 dark:text-white">
                        <a class="hover:text-orange" href="detail.html">
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    <td class="w-32 p-4">
                        <a class="hover:opacity-75" href="detail.html">
                            <img src="assets/pictures/car_ceed.png" alt="">
                        </a>
                    </td>
                    <td class="px-6 py-4 font-semibold text-gray-900 dark:text-white">
                        <a class="hover:text-orange" href="detail.html">
        ...
        <div class="flex items-center pt-6">
            ...
            <span class="text-lg font-bold text-gray-800 ">2 500 000 ₽</span>
        </div>
        <div class="pt-3 flex items-center justify-between">
            <a class="bg-orange hover:bg-opacity-70 focus:outline-none text-white font-bold py-2 px-4 rounded" href="#">Оформить заказ</a>
        </div>
